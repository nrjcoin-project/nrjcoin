...
{
    return GetBoolArg("-testnet", false) ? NRJ_TESTNET_RPC_PORT : NRJ_RPC_PORT;
}
...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Nrjcoin server stopping";
}
...
string HTTPPost(const string& strMsg, const map<string,string>& mapRequestHeaders)
{
    ostringstream s;
    s << "POST / HTTP/1.1\r\n"
      << "User-Agent: nrjcoin-json-rpc/" << FormatFullVersion() << "\r\n"
      << "Host: 127.0.0.1\r\n"
...
void StartRPCThreads()
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use nrjcoind";
